                    ...
                    <div class="sortuj">
                        <table class="table">
                            ...
                            <c:forEach var="visit" items="${VISITS_LIST}">
                                ...
                                <c:url var="cancelVisit" value="ServletUpcomingVisits">
                                    <c:param name="command" value="CANCEL"></c:param>
                                    <c:param name="specialistId" value="${visit.visitSpecialistId}"></c:param>
                                    <c:param name="placeId" value="${visit.visitPlaceId}"></c:param>
                                    <c:param name="visitDate" value="${visit.visitDate}"></c:param>
                                    <c:param name="hourId" value="${visit.visitHourId}"></c:param>
                                </c:url>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${cancelVisit}"
                                           onclick="if(!(confirm('Czy na pewno chcesz anulować wizytę?'))) return false">
